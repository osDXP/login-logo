...
Author: Mark Jaquith - osDXP version by CrowdFavorite
Author URI: http://coveredwebservices.com/

==========================================================================

Copyright 2011-2018  Mark Jaquith
...
if (defined('OSDXP_DASHBOARD_VER')) {
	...
	define('OSDXP_LL_UPDATE_URL', 'https://osdxp.org/wp-content/modules/osdxp-login-logo.json');
